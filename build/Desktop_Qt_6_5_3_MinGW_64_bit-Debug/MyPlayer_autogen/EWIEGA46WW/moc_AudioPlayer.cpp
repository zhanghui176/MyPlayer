...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAudioPlayerENDCLASS_t qt_meta_stringdata_CLASSAudioPlayerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 15),  // "AudioFrameReady"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 8),  // "AVFrame*"
...
void AudioPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->AudioFrameReady((*reinterpret_cast< std::add_pointer_t<AVFrame*>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AudioPlayer::*)(AVFrame * );
            if (_t _q_method = &AudioPlayer::AudioFrameReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void AudioPlayer::AudioFrameReady(AVFrame * _t1)
{
