...
Q_CONSTINIT static const qt_meta_stringdata_CLASSAVPlayerENDCLASS_t qt_meta_stringdata_CLASSAVPlayerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(9, 15),  // "videoframeReady"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 8),  // "AVFrame*"
        QT_MOC_LITERAL(35, 5),  // "frame"
        QT_MOC_LITERAL(41, 15)   // "audioframeReady"
    },
    "AVPlayer",
    "videoframeReady",
    "",
...
void AVPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->audioframeReady((*reinterpret_cast< std::add_pointer_t<AVFrame*>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (AVPlayer::*)(AVFrame * );
            if (_t _q_method = &AVPlayer::videoframeReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (AVPlayer::*)(AVFrame * );
            if (_t _q_method = &AVPlayer::audioframeReady; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void AVPlayer::videoframeReady(AVFrame * _t1)
{
...
// SIGNAL 1
void AVPlayer::audioframeReady(AVFrame * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
